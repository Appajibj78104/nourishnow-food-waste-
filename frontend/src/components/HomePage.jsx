                    ...
                    <div className="relative h-full flex items-center justify-center px-4">
                        ...
                        >
                            ...
                            <p className="text-lg md:text-xl text-gray-300 mb-8">
                                Join our mission to bridge the gap between food surplus and scarcity.
                            </p>
                            <motion.div
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 p-8 z-20">
                                    ...
                                    <p className="text-gray-200">Make a difference in someone's life today</p>
                                </div>
                            </motion.div>
                            <motion.div
                                className="relative rounded-2xl overflow-hidden h-[400px]"
                            ...
                            >
                                ...
                                />
                                <div className="absolute bottom-0 left-0 p-8 z-20">
                                    <h3 className="text-2xl font-bold text-white mb-2">Easy Donation Process</h3>
                                    <p className="text-gray-200">Simple steps to share your surplus food</p>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="relative z-20 container mx-auto px-4">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-xl text-gray-300 mb-12">
                                Together, we've helped thousands of people access nutritious meals
                                while reducing food waste in our communities.
                            </p>
                        </div>
                    </div>
                </motion.section>
                ...
                >
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            >
                                <dt className="text-sm leading-6 text-gray-300">Food Waste in India</dt>
                            ...
                            >
                                <dt className="text-sm leading-6 text-gray-300">People Undernourished</dt>
                                <dd className="order-first text-3xl font-semibold tracking-tight text-white">
                            ...
                            >
                                <dt className="text-sm leading-6 text-gray-300">Meals Donated</dt>
                                <dd className="order-first text-3xl font-semibold tracking-tight text-white">
                        ...
                        >
                            ...
                            <div className="relative rounded-2xl bg-gradient-to-r p-[1px] from-blue-500 to-teal-500">
                                <div className="rounded-2xl bg-[#111827] p-8 h-full">
                                    ...
                                    <h3 className="text-lg font-semibold text-white mb-2">Easy Donation</h3>
                                    <p className="text-gray-400">Seamless process to donate surplus food and make an immediate impact.</p>
                                </div>
                            </div>
                            ...
                            <div className="relative rounded-2xl bg-gradient-to-r p-[1px] from-teal-500 to-emerald-500">
                                <div className="rounded-2xl bg-[#111827] p-8 h-full">
                                    ...
                                    <h3 className="text-lg font-semibold text-white mb-2">Quick Pickup</h3>
                                    <p className="text-gray-400">Efficient collection service ensuring food reaches those in need.</p>
                                </div>
                            </div>
                            ...
                            <div className="relative rounded-2xl bg-gradient-to-r p-[1px] from-emerald-500 to-blue-500">
                                <div className="rounded-2xl bg-[#111827] p-8 h-full">
                                    ...
                                    <p className="text-gray-400">Partner with trusted organizations to maximize donation impact.</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl px-6 mt-32 sm:mt-40 pb-20">
                        ...
                        >
                            ...
                            <p className="mt-4 text-lg text-blue-100">
                                Join our community of donors and help create a hunger-free world.
                            </p>
                            <div className="mt-8">
                                <Link 
                                    to="/register" 
